...
knitr::opts_knit$set(root.dir = "/Users/claytoncarey/Documents/Seurat/micdrop_seq/micdrop/Figure_code/Figure 4/")
...
```{r}
dcell_lineage <- read_csv(file = "/Users/claytoncarey/Documents/Seurat/micdrop_seq/micdrop/Label_Transfer/pseudobulk_analysis/DEG_V3/dcell_lineage_codes.csv")

dcell <- readRDS(file = "/Users/claytoncarey/Desktop/dcell_3_24.rds")

combined.meta <- readRDS(file = "/Users/claytoncarey/Documents/Seurat/micdrop_seq/micdrop/Label_Transfer/pseudobulk_analysis/DEG_V3/lineagemeta.rds")
...
coords <- readRDS(file = "/Users/claytoncarey/Documents/Seurat/micdrop_seq/micdrop/Label_Transfer/pseudobulk_analysis/Autonomy_igraph/coords_layout.rds")
#load curated groupings and color palettes for igraph 
community_colors <- read.csv(file = "/Users/claytoncarey/Documents/Seurat/micdrop_seq/micdrop/autonomyscratch/community_colors.csv", header = TRUE)
...
plot_with_path <- function(gene, celltype){
  ...
  links <- read.csv(file = "/Users/claytoncarey/Documents/Seurat/micdrop_seq/micdrop/Label_Transfer/pseudobulk_analysis/Autonomy_igraph/links_full.csv", header = TRUE)


  nodes <- read.csv(file = "/Users/claytoncarey/Documents/Seurat/micdrop_seq/micdrop/Label_Transfer/pseudobulk_analysis/Autonomy_igraph/nodes_full2.csv")
...
png(
    filename = "/Users/claytoncarey/Documents/Seurat/micdrop_seq/micdrop/Figure_code/Figure 4/Figure_4C.png", 
    height = 10, 
    width = 13, 
    units = "in", 
    res = 300
...
pct_perturbed <- autonomy_df_class %>% 
  ...
  count(autonomy_possible, effect_type) %>% 
...
```{r}
vasc_measure <- read.csv(file = "/Users/claytoncarey/Documents/Seurat/micdrop_seq/micdrop/Figure_code/Figure 4/tp63_vascular_measurements_2nd_somite.csv")
...
```{r}
isv <- read.csv(file = "/Users/claytoncarey/Documents/Seurat/micdrop_seq/micdrop/Figure_code/Figure 4/isV_with_flow.csv")
...
ggsave(filename = "FigureS11A.svg", 
             device = "svg",
             width = 1.5, 
             height = 3,
             units = 'in',
...
ggsave(filename = "FigureS11B-1.png", 
             device = "png",
             width = 6, 
             height = 6,
             units = 'in',
...
ggsave(filename = "FigureS11B-2.png", 
             device = "png",
             width = 6, 
             height = 6,
             units = 'in',
...
ggsave(filename = "FigureS11B-3.png", 
             device = "png",
             width = 6, 
             height = 6,
             units = 'in',
...
ggsave(filename = "FigureS11C.png", 
             device = "png",
             width = 8, 
             height = 8,
             units = 'in',
...
ggsave(filename = "FigureS11D.svg", 
             device = "svg",
             width = 1.5, 
             height = 3,
             units = 'in',
...
```{r}
fa <- read.csv(file = "/Users/claytoncarey/Documents/Seurat/micdrop_seq/micdrop/Figure_code/Figure 4/flow_area.csv")
fa %>% 
  pivot_longer(cols = everything()) %>% 
  dplyr::rename("injection" = "name" ,  "flow" = "value"  ) %>% 
  ggplot(aes(x = injection, y = flow)) +
...
ggsave(filename = "FigureS11I.svg", 
             device = "svg",
             width = 1.5, 
             height = 3,
             units = 'in',
...
bpm <- read.csv(file = "/Users/claytoncarey/Documents/Seurat/micdrop_seq/micdrop/Figure_code/Figure 4/bpm.csv")
...
ggsave(filename = "FigureS11H.svg", 
             device = "svg",
             width = 1.5, 
             height = 3,
             units = 'in',
